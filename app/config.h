...
#define I2S_MIC_SD_PIN GPIO_NUM_32   // I2S data pin (DOUT from INMP441)
#define I2S_MIC_SCK_PIN GPIO_NUM_2   // I2S clock pin (BCLK)
#define I2S_MIC_WS_PIN GPIO_NUM_33   // I2S word select pin (WS/LRCLK)
...
#define I2S_SPEAKER_DOUT_PIN GPIO_NUM_20  // I2S data output pin (DIN)
#define I2S_SPEAKER_BCLK_PIN GPIO_NUM_26  // I2S bit clock pin (BCLK)
#define I2S_SPEAKER_LRC_PIN GPIO_NUM_27   // I2S word select pin (WS/LRCLK)
...
#define DISPLAY_SDA_PIN 21               // I2C SDA pin (GPIO 21)
#define DISPLAY_SCL_PIN 22               // I2C SCL pin (GPIO 22)
